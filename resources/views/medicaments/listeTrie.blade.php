...
<button type="button" class="btn btn-outline-success ms-2 fs-5">Digestion</button>
<button type="button" class="btn btn-outline-success ms-2 fs-5">Douleurs - Fièvre</button>
