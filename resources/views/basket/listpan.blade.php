...
<div class="container">
	...
	<div class="table-responsive  mb-3">
		<table class="table table-bordered table-hover bg-white mb-0">
			...
			<tbody>
				...
				@php $total += $pan->prix_unitaire * $pan->quantites @endphp
                  ...
                  <td>  
                <form  action="{{route('appartenires.update',$pan->id)}}" method="POST" class="form-inline d-inline-block" >
                    @csrf
					@method('put')
				...
				<td>
					...
					<a href="{{route('appartenires.delete',$pan->id) }}" type="submit" class="btn btn-outline-danger" title="Retirer le produit du panier" >Retirer</a>
		...
		@if($paniers)
			<thead class="thead-dark" >
				<tr colspan="4"><td colspan="6" ></td></tr>
				<tr>
					<th style="widht:45px; height:45px;">&#x1F6CD;</th>
					<th>Produits</th>
					<th>Prix</th>
	...
	<a class="btn btn-outline-success  mb-3 ms-4 mt-1 fs-5" href="/" title="Retourner pour conntinuer l'acha" >Continuer votre achat</a>

	<a class="btn btn-success mb-3 fs-5 mt-1"  style="margin-left:850px "  href="{{ route('commande') }}" title="commander" >Commander</a>
	@else
