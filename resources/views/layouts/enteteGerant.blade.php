...
<nav class="navbar navbar-expand-lg navbar-light  shadow " style=" height:50px ;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      @auth
      @endauth
      <a class="navbar-brand" href="#"><span class="mt-2 ms-2" >SEN</span>PHARMACIE</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link mt-2" href="/Pharmacie" style="text-transform: uppercase; ">Ajouter une Pharmacie</a>
          </li>
      </ul>
      <!-- Left links -->
    </div>
