...
<nav class="navbar  p-3 bg-success text-white">
  ...
  //$c = DB::select('select * from appartenires  where  id_panier=?', [$s])->count();
  $c=DB::table('possedes')->count();
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-3 mb-lg-0">
        ...
        <li class="nav-item">
          <a style="text-transform: uppercase;" class="nav-link  mt-2" href="{{ route('listePharmaciecl') }}">Listes pharmacies</a>
          </li>
          <li class="nav-item">
